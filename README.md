...
- 2024.07.24 講義スケジュールの一部を変更しました
- 2024.07.18 トレーニングコース用ウェブサイトを立ち上げました
...
- Lin4Neuroでの受講を推奨しますが、macOS native 環境で受講したい方々のために、インストラクションを準備しました。[こちら](macOS_native.md) をご確認ください。Lin4Neuroのインストール手順は、ページ下方にあります。
    - **本コースの受講で必要なSPMのインストールのみで結構です。以下の２つのケースで準備の方法が異なります。**
        - MATLAB上でSPMを利用する場合 **<u>（MATLABのライセンスが必要）</u>**
        - MATLABなしでSPMを利用する場合
    - macOS native環境の場合、完全なサポートができない可能性があることをご承知おきください。
